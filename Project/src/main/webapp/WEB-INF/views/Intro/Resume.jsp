...
<div class="ds_mall" style = " width:1200px; margin:0 auto; overflow:hidden">
	...
	<div class="lnb">
		...
		<ul>
			...
			<li class="current"><a href="/intro/resume.do">이력서</a></li>
		...
		<div id="printForm">
					...
					<table class="qr_table" style="margin:20px;">
						...
						<tbody>
							...
							<tr style="height:42px;">
								...
								<td style="text-align:center">2019-10-08 ~ 2020-03-27</td>
			...
			<div class="tab_con02" style="display:none;">
				<div style="text-align:center;margin-top:50px;">
					...
					<p style="padding: 10px 0; margin:30px auto; line-height:2; font-size:1rem;text-align:left;">
						&nbsp;&nbsp;전공과목의 강의 프로젝트와 하고 있었던 대외활동의 축제가 동일 기간에 진행되는 일이 발행하였습니다. 두 프로젝트를 모두 진행하면서 최선을 다해 다른 조원들에게 피해가 가지 않는 것을 목표로 삼았습니다. 그러기 위해서는 시간 단축이 필요했습니다. 개인에게 할당된 시간을 최대한 효율적으로 사용하기 위해 팀원 간 직접 대면을 만나는 시간을 줄이고 그 시간을 활용하자고 팀원들을 설득하였고 개개인에게 일정 과제를 부여하여 취합하는 형태로 진행하기로 하였습니다. 축제가 시작되기 한 달 전, 축제 행사팀장의 자리가 공석이 되어 제가 행사팀장으로 임명받았고 행사팀의 부원들과 같이 일을 하게 되었습니다. 행사팀의 부원들은 새로운 상급자를 그리 반가워하지 않았습니다. 회의는 언제나 형식적이었고 모든 일에 비협조적이었습니다. 이런 부원들의 행동이 서운하게 느껴졌지만 나라고 다르게 행동했을까 생각하며 스스로 먼저 변해 보도록 노력했습니다. 먼저 ‘소통하는 팀장’이라는 이미지를 심어주기 위해 노력했습니다. 업무 분배를 할 때도 적극적으로 기존의 업무 방식에 대해서도 물어보고 새로 할당된 업무와 비교하여 충분히 해결할 수 있는지 의견을 나눈 후 저 자신에게 업무를 조금 더 부여하였고 잠을 줄여가며 고군분투하였습니다. 축제가 마무리되어 갈 때쯤이면 아침 해를 보는 것은 다반사였고 처음에는 커뮤니케이션이 잘 안된다는 불평을 토로하던 부원들도 어느새 회의 때마다 열띤 토론장을 펼쳤고 학기가 끝날 때는 어느 팀보다도 끈끈한 팀워크를 자랑할 수 있었습니다.<br/>
	
						&nbsp;&nbsp;이런 끈기와 책임감을 느끼고 과제와 축제 모두 성공적으로 끝나 팀원이라는 인적자원과 과제에서 높은 점수를 받아서 두 마리 토끼를 거머쥐는 경험을 하였습니다. 이러한 저의 경험치를 바탕으로 지원한 회사에서도 인정받는 소중한 인적자원이 되겠습니다.
					</p>
					<div style="border-bottom:1px solid #ccc;margin:50px 0;"> </div>
			...
			<div class="tab_con03" style="display:none;">
						...
						<tr>
							...
							<td colspan="3">
								1) 프로젝트명 : 축산경영정보시스템 스마트 팩토리 구축<br/>
									...
									&nbsp;- 개발 인원 : 2명<br/>
									&nbsp;- 상세 내용 : Spring MVC 개발, 강의 검색 페이지, 사격장 브리핑 문서 인쇄 페이지, 비행 임무 계획 유지관리<br/>
				...
				<table class="rq_table" style="margin-top:10px;">
					...
					<tbody>
						...
						<tr>
							<th>근무기간</th>
							<td>2019-10-08 ~ 2020-03-27</td>
							<th>근무처 사업업종</th>
							<td>SI 프로젝트 사업</td>
						</tr>
						<tr>
							<th>퇴직사유</th>
							<td colspan="3">COVID-19로 인한 경영악화</td>
						</tr>
						<tr>
							<th>주요업무</th>
							<td colspan="3">
						...
						<tr>
							...
							<td colspan="3">
								...
								<br/>
								2)프로젝트명 : 국기원 태권도 승품단 심사 전자채점시스템<br/>
								...
								&nbsp;- 개발 인원 : 2명<br/>
								&nbsp;- 상세 내용 : <br/>
								     &nbsp;&nbsp;&nbsp;&nbsp;- Spring MVC 개발, 관리자 페이지, 결과 페이지, 통계 페이지<br/>
								     &nbsp;&nbsp;&nbsp;&nbsp;- C# .NET 개발, 심사위원 채점 프로그램, 심사 일정표 프로그램, 심사 진행 프로그램<br/>
							</td>
						</tr>
					</tbody>
				</table>
				...
				<script>
					...
					$("#btnPrint").click(function(){
						$("#printForm").addClass("page");
						$("#printForm").printThis({
							debug: false,
							importCSS: true,
							printContainer: true,
							loadCSS: "${path}/resources/css/custom.css",
							pageTitle: "",
							removeInline: false,
							header: null,
							footer: null
